...
EGO_SUM=(
	...
	"github.com/fsnotify/fsnotify v1.5.0/go.mod"
...
SRC_URI="https://github.com/${PN}/${PN}/archive/v${PV}.tar.gz -> ${PN}.tar.gz
		${EGO_SUM_SRC_URI}"
...
src_prepare() {
	eapply "${FILESDIR}/${PN}-remove-installer-upgrade-functions.patch"
	rm upgrade.go
	rm install.sh
	default
}
